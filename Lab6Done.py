...
#In every region, there is no association between women in national parliament and life expectancy for women.
...
#In every region, greenhouse gas emissions are constant despite the fluctuation of women's life expectancy.
...
#In every region, the association between internet use and life expectancy for women is linear.
